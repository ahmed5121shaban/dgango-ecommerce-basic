...
from .views import ProductsList,ProcuctDetail,BrandList,BrandDetail,CategoryList,post_list,add_reviews
...
urlpatterns = [
    ...
    path('<int:id>/add-reviews',add_reviews,name='add_reviews'),
